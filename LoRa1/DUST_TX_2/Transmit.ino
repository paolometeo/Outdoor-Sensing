...
// Transmission
  ...
  if(ECHO){
    ...
    Serial.print(" Conc10: ");Serial.print(minni.Data30005.Conc10,0);Serial.print(" ");
    Serial.print(" Conc25: ");Serial.print(minni.Data30005.Conc25,0);Serial.print(" ");
    Serial.print(" Temp: ");Serial.print(minni.Data30005.TEMP,1);Serial.print(" ");
    Serial.print(" Umid: ");Serial.print(minni.Data30005.UMID,1);Serial.print(" ");
    Serial.println();
    }
